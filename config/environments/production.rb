Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "package_vulns_#{Rails.env}"
  ...
  # (e.g. sending email).
  config.action_mailer.default_url_options = { host: ENV.fetch("HOSTNAME", "package-vulns.herokuapp.com") }
